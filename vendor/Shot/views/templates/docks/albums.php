<script id="template-dock-albums" type="text/template">
	<div id="edit-mode">
		<div class="row">
...
<?php include 'vendor/Shot/views/templates/modals/albums/edit-selection.php' ?>
<?php include 'vendor/Shot/views/templates/modals/albums/delete-selection.php' ?>
